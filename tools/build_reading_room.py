...
def main():
    ...
    data = {
        ...
        "findings": [f for f in load_yaml("findings.yaml")["findings"] if f.get("page", True)],
        "findings_withheld": sum(1 for f in load_yaml("findings.yaml")["findings"] if not f.get("page", True)),
